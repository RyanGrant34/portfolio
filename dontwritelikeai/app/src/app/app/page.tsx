      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 py-8">
        ...
        {plan === "pro" && (
          <div className="flex items-center gap-2 mb-4">
            <span className="text-[0.65rem] font-mono text-[var(--accent)] uppercase tracking-[0.2em]">
              // tone
            </span>
            {(Object.keys(TONE_LABELS) as TonePreset[]).map((t) => (
              <button
                ...
                onClick={() => setTone(t)}
                className={cn(
                  "text-xs font-mono px-3 py-1 border transition-all",
                  tone === t
                    ? "border-[var(--accent)] text-[var(--accent)] bg-[var(--accent)]/10"
                    : "border-[var(--ghost)]/40 text-[var(--muted)] hover:text-[var(--accent)] hover:border-[var(--accent)]/30"
                )}
              >
                {TONE_LABELS[t]}
              </button>
        ...
        {/* Input area */}
        <div className="border border-[var(--ghost)]/60 bg-[var(--ink-light)] focus-within:border-[var(--accent)]/40 transition-colors">
          {/* Terminal header */}
        ...
        <div className="flex flex-wrap gap-2 mt-3">
          {[
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1 bg-[var(--ink-light)] hover:bg-[var(--ink-mid)] border border-[var(--ghost)]/40 hover:border-[var(--accent)]/30 text-[var(--muted)] hover:text-[var(--accent)] transition-all text-xs font-mono"
            >
              {s.icon}
              {s.label}
            </button>
        ...
        {output && (
          <div ref={outputRef} className="mt-8">
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                onClick={handleCopy}
                className="flex items-center gap-1.5 font-mono text-xs text-[var(--muted)] hover:text-[var(--accent)] transition-colors border border-[var(--ghost)]/40 px-3 py-1.5 hover:border-[var(--accent)]/30"
              >
